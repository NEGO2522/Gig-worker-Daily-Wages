...
import { LockClosedIcon, EnvelopeIcon, UserIcon, BriefcaseIcon } from '@heroicons/react/24/outline';
import { useNavigate, Link } from 'react-router-dom';
import { signInWithGoogle, signInWithGitHub, logInWithEmailAndPassword, sendPasswordReset } from '../firebase/firebase';
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex justify-center py-2 px-4 border border-black rounded-none text-sm font-medium text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-colors duration-200 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <button
                  ...
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50"
                >
